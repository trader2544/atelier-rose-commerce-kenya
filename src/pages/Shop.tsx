    ...
    <div className="min-h-screen bg-gradient-to-br from-pink-50 via-white to-purple-50 pt-20 pb-16">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12">
          <h1 className="text-4xl font-light text-gray-800 mb-4">Shop Collection</h1>
          <p className="text-xl text-gray-600">Discover our curated selection of elegant pieces</p>
        </div>
        ...
        <div className="flex flex-col md:flex-row gap-4 mb-8">
          <div className="relative flex-1">
            ...
            <Input
              ...
              className="pl-10 bg-white/70 border-pink-200 focus:border-pink-400"
            />
          </div>
          <Select value={selectedCategory} onValueChange={setSelectedCategory}>
            <SelectTrigger className="w-full md:w-48 bg-white/70 border-pink-200">
            ...
            {filteredProducts.map((product) => (
              <Card key={product.id} className="group overflow-hidden bg-white/80 backdrop-blur-sm border-pink-100 hover:shadow-lg transition-all duration-300">
                ...
                <CardContent className="p-4">
                  ...
                  <Badge className="bg-pink-100 text-pink-800 text-xs mb-2">{product.category}</Badge>
